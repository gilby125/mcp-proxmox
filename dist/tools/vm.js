export function getVmTools(proxmoxManager) {
    const listTools = () => {
        return [
            {
                name: 'get_vms',
    ...
    const executeVmCommand = async (args) => {
        const type = args.type || 'qemu';
